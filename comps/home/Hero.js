        ...
        <div className="text-center">
         ...
         <Link href="/becomeapartner">
          ...
          <a 
                    ...
                    href='/about'>
                  <span className='relative after:absolute after:bg-white after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300 text-sm text-white'>Learn more</span>  
