    ...
    <section style={{paddingBottom:'90px'}} className="py-14 bg-green-100">
            <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
                ...
                <div className="flex gap-3 items-center mt-4 md:justify-center">
                    <a href="becomeapartner" className="inline-block py-2 px-4 text-white font-medium bg-gray-800 duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-lg shadow-md hover:shadow-none">
                        Get started
                    </a>
                    <a href="/about" className="inline-block py-2 px-4 text-gray-800 font-medium duration-150 border hover:bg-gray-50 active:bg-gray-100 rounded-lg">
                        Learn more
                    </a>
                </div>
            </div>
